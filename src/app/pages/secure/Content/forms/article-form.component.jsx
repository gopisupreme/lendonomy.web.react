...
import { COMMON_CONST, CONTENT_MANAGER_ARTICAL_FORM_CONST } from "app/common/constants/constant";
...
const validate = (values) => {
  ...
  if (!values.pic1) {
    errors.pic1 = "Required";
  }
  if (!values.content1?.trim()) {
...
const ArticleForm = (props) => {
  ...
  useEffect(() => {
    ...
    // if (articlResp && Object.keys(articlResp).length)
    // setArticleForm(articlResp);
    ...
    if (formInitialvalue) setArticleForm(formInitialvalue);
  }, [articlResp]);
  ...
  const onSubmit = (values) => {
    ...
    articleReqForm.contType = APP_CONST.CONTENT_TYPE.ARTICLE;
    console.log("add", articleReqForm)
  ...
  return (
    <>
      <Form
        ...
        validate={validate}
        render={({ handleSubmit, submitting, pristine, form, values, touched, errors }) => (
          <>
            {console.log(values
            ...
            <form className="mt-5" onSubmit={handleSubmit}>
              <div className="row">
                <div className="col-lg-6">
                  <Field
                    ...
                    label={CONTENT_MANAGER_ARTICAL_FORM_CONST.ARTICLE_NAME}
                    placeholder={CONTENT_MANAGER_ARTICAL_FORM_CONST.ARTICLE_NAME_PLACEHOLDER}
                  />
                </div>
                <div className="col-lg-6">
                  <Field
              ...
              <div className="row">
                ...
                <div className="col-lg-3">
                  <label className="font-weight-bold">{CONTENT_MANAGER_ARTICAL_FORM_CONST.ARTICLE_THUMNAIL}</label>
                  <Field
                    name="pic1"
                    component={ImageUpload}
                    label={CONTENT_MANAGER_ARTICAL_FORM_CONST.UPLOAD_IMAGE_LABEL}
                    accept="image/*"
                    parse={(value) => parseBase64(value, form, "pic1Format")}
                    defaultImage={formInitialvalue && formInitialvalue.pic1}
                    errorDisplayName="thumbnail"
                  />
                </div>
              </div>
              <div className="row">
                <div className="col-12">
                  <Field
                    ...
                    label={CONTENT_MANAGER_ARTICAL_FORM_CONST.PARAGRAPH1}
                    placeholder={CONTENT_MANAGER_ARTICAL_FORM_CONST.PARAGRAPH1_PLACEHOLDER}
                    rows="6"
                  />
                </div>
              </div>
              <div className="row">
                <div className="col-lg-4">
                  <label className="font-weight-bold">{CONTENT_MANAGER_ARTICAL_FORM_CONST.INSIDE_TEXT_IMAGE}</label>
                  <Field
                    name="pic2"
                    component={ImageUpload}
                    label={CONTENT_MANAGER_ARTICAL_FORM_CONST.UPLOAD_IMAGE_LABEL}
                    accept="image/*"
                    parse={(value) => parseBase64(value, form, "pic2Format")}
                    defaultImage={formInitialvalue && formInitialvalue.pic2}
                    errorDisplayName="inside text image"
                  />
                </div>
                ...
                <div className="col-lg-3">
                  ...
                  <Field
                    ...
                    label={CONTENT_MANAGER_ARTICAL_FORM_CONST.UPLOAD_IMAGE_LABEL}
                    accept="image/*"
                    parse={(value) => parseBase64(value, form, "logoFormat")}
              ...
              <div className="row">
                <div className="col-12">
                  <Field
                    ...
                    type="text"
                    component={TextAreaRenderField}
                    label={CONTENT_MANAGER_ARTICAL_FORM_CONST.PARAGRAPH2}
                    placeholder={CONTENT_MANAGER_ARTICAL_FORM_CONST.PARAGRAPH2_PLACEHOLDER}
                    rows="6"
                  />
                </div>
              </div>
              ...
              {(values.quiz && values.quiz.req === "Yes") || values
                && Object.keys(values).length === 0
                && Object.getPrototypeOf(values) === Object.prototype ? (
                <>
                  <div className="mb-3">
              ...
              <div className="d-flex py-4">
                ...
                // disabled={formLoader}
                >
                  {articleForm ? CONTENT_MANAGER_ARTICAL_FORM_CONST.SAVE_AND_STAGE : CONTENT_MANAGER_ARTICAL_FORM_CONST.MOVE_TO_STAGING}
                </button>
                {articleForm &&
                  articleForm.articleStatus !==
