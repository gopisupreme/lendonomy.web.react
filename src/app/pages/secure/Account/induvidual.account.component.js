...
import { INDIVIDUAL_ACCOUNT_CONST, COMMON_CONST, ACCOUNT_LIST_CONST, USER_ROLE_CONFIG_KEY, NAVIGATION_ROUTE_FROM } from 'app/common/constants/constant';
...
import { ADMIN, LIST, SIDEBAR_ACCOUNT, SIDEBAR_ANALYTICS, SIDEBAR_RISKASSESSMENT } from 'app/common/constants/api.constants';
...
function InduvidualAccount(props) {
  ...
  const userId =
    props.location.state.userData.id || props.location.state.userData.userId;
  ...
  function getProfile() {
    return (
      <div className={'mt-3 container-area'}>
        <div className='row'>
          <div
            className={`col-sm-2 ${styles.indGetProfileImgContainer}`}
            >
            {userData && userData.picture ? (
              <img
                className={styles.indGetProfileImgStyle}
          ...
          <div>
            ...
            <div className={`row ${classNames(styles.addressInfo)}`}>
              ...
              <div className={styles.indGetProfileContentSpace}>
  ...
  function getAccountOverview() {
    return (
      <div
        className={`mt-2 pb-4 container-area ${styles.indGetAccountContainer}`}>
        <h2
        ...
        <div className='mt-3'>
          <div className={styles.rowData}>
            <div className={styles.col}>
              <h1
                className={`display-5 ${styles.indGetAccountLastOnline}`}>
            ...
            <div className={styles.col}>
              <h1
                ...
                {checkValid(userData.matchingFeePaid)
                  ...
                  : APP_CONST.NA}
                <span
                  className={`align-text-middle ml-2 ${styles.indGetAccountFeeText}`}>
                  {checkValid(userData.matchingFeePaid) &&
    ...
    return (
      <div
        ...
        <h2
          ...
          {INDIVIDUAL_ACCOUNT_CONST.BEHAVIOUR}: {INDIVIDUAL_ACCOUNT_CONST.DISCOVER}, {COMMON_CONST.LOAN_PURPOSE}
        </h2>
        <div className='mt-3'>
          <div className={styles.rowDataBehaviour}>
            ...
            <div className={styles.colBehaviour}>
              <h1
                className={`display-5 ${styles.indGetBehaviourLeastText}`}>
        ...
        <div className='mt-4'>
          ...
          <div className='row mt-4'>
            <div className='col-sm-6'>
              <div className='d-flex flex-row justify-content-start align-items-center'>
                <div
                  ...
                  <span
                    className={`pi pi-minus ${styles.indGetAddDetuctIconStyle}`}
                    // style={{fontSize: '2em'}}
                  />
                </div>

                <div
                  className={styles.indGetAddDetuctPointContainer}
                  >
                  <h1
                    className={`${trustScore >= 0 ? styles.indGetAddDetuctPositivePoint : styles.indGetAddDetuctNegativePoint}`}
                    >
                    {`${
                ...
                <div
                  ...
                  onClick={() => setTrustScore(trustScore + 1)}>
                  <span
                    className={`pi pi-plus ${styles.indGetAddDetuctIconStyle}`}
                    // style={{fontSize: '2em'}}
                  />
                </div>
              </div>
            ...
            <div className='d-flex flex-row col-sm-6'>
              <div
                className={styles.indGetAddDetuctTextAreaContainer}
                >
                <textarea
                  value={reason}
                  placeholder={INDIVIDUAL_ACCOUNT_CONST.TEXTAREA_PLACEHOLDER}
                  className={styles.indGetAddDetuctTextAreaStyle}
                  rows={4}
            ...
            { UtilsHelper.checkUserRole(USER_ROLE_CONFIG_KEY.ACC_MANUAL_ADD_DETUCT) && 
              <div
                className={`d-flex align-items-center ${styles.indGetAddDetuctButtonStyle}`}
               >
                <button
                  onClick={onSend}
                  className={classNames(
          ...
          {userData?.tsAudit ? (
            <div className='col-sm-8 ts-table'>
              <DataTable
                ...
                scrollHeight='230px'
                scrollable={true}
                className={styles.indDataTableStyle}
                ...
                <Column
                  headerClassName={styles.indDataTableCommentStyle}
                  bodyClassName={styles.indDataTableCommentStyle}
                  field='comments'
  ...
  function navigateToAccountList() {
    ...
    const {ANALYTICS ,RISK_ASSESSMENT} = NAVIGATION_ROUTE_FROM;
    ...
    switch(from){
     case RISK_ASSESSMENT:
      navigationRoutePath = ADMIN + SIDEBAR_RISKASSESSMENT;
      break;
     case ANALYTICS:
      navigationRoutePath = ADMIN + SIDEBAR_ANALYTICS;
      break;
     default: 
      navigationRoutePath = ADMIN + SIDEBAR_ACCOUNT + LIST;
      break;
      ...
      <div
        ...
        <div className='col-12'>
          ...
          <div className='row'>
            <span
              role='button'
              className={`pi pi-arrow-left ${styles.IndNavLeftIconStyle}`}
              // style={{fontSize: '2em'}}
